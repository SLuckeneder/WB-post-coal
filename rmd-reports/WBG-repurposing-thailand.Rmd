---
title: "WBG post-coal mining land repurposing in Thailand"
author: "TBC / WU"
date: "`r Sys.Date()`"
...
suitable_map$suitability <- factor(
  ...
  levels = c("Solar", "Multiple use") # no polygon suitable for wind
)
...
mapview(
  ...
  col.regions = c("#FFD700", "#FF4500"), # no polygon suitable for wind
