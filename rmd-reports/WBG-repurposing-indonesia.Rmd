---
title: "WBG post-coal mining land repurposing in Indonesia"
author: "TBC / WU"
date: "`r Sys.Date()`"
...
suitable_map$suitability <- factor(
  ...
  levels = c("Solar", "PHES", "Multiple use") # no polygon suitable for wind, but single PHES
)
...
mapview(
  ...
  col.regions = c("#FFD700", "#00FFFF", "#FF4500"), # no polygon suitable for wind, but single PHES
